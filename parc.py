...
for index, row in data_fields.iterrows():
    ...
    for index2, row2 in data_spec.iterrows():
        ...
        for i in range(0, 20):
            url = f"https://hh.ru/search/vacancy?area=113&search_field=name&search_field=company_name&search_field=description&enable_snippets=false&L_save_area=true&industry={id_field}&professional_role={id_spec}&page={i}"
